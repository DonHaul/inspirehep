...
MIGRATION_MODULES = {"sites": "backoffice.contrib.sites.migrations"}
...
ACCOUNT_FORMS = {"signup": "backoffice.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "backoffice.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "backoffice.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Documentation of API endpoints of backoffice",
    "VERSION": "1.0.0",
...
OPENSEARCH_INDEX_NAMES = {
    "authors": f'{env("OPENSEARCH_INDEX_PREFIX")}-author-workflows',
}
